...
import klass from './CSSutil/cssClasses'
import CSSTranslate from './CSSutil/cssTranslate'
import Swipe from './components/EasySwap'
import * as customPropTypes from './components/customPropTypes'
...
class Carousel extends Component {
    ...
    setupCarousel () {
        ...
        if (this.state.autoPlay && this.props.children.length > 1) {
            this.setupAutoPlay()
        }
    ...
    renderControls () {
        ...
        return (
            <ul className={classes.dots_list}>
                {Children.map(this.props.children, (_, index) => {
    ...
    render () {
        ...
        return (
            <div ref={this.setCarouselWrapperRef}>
                <div className={klass.CAROUSEL(true)} style={{width: this.props.width}}>
                    <button type="button" className={classes.control_prev} onClick={this.onClickPrev} />
                    ...
                    <button className={classes.control_next} onClick={this.onClickNext} />
                    { this.renderControls() }
                </div>
            </div>
        )
